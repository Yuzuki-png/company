  ...
  return (
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md terms-of-service-content">
          <section className="mb-8">
            <p className="mb-4">
              この利用規約（以下，「本規約」といいます。）は，株式会社月の庭（以下，「当社」といいます。）がこのウェブサイト上で提供するオンラインショップ（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
            </p>
          </section>
